...
function getDefaultReactions() {
  return {
    ...
    "😂,🤣,😆,🤪,😹": ["funny", "laugh", "hilarious", "amusing", "comical", "humorous", "joke", "laughter", "lol", "rofl"],
    ...
    "🥰,☺️,😊,🙏,❤️": ["welcome", "you're welcome", "wlc", "most welcome"],
    ...
    "🤫,🫢,😶,🕊️,☮️": ["quiet", "silent", "hushed", "still", "noiseless"],
